    ...
    for sh in sh_degree:
        for rc in reg_constant:
            ...
            for scene in mipnerf360_indoor_scenes:
                source = args.mipnerf360 + "/" + scene
                os.system("python train.py -s " + source + " -i images_2 -m eva/" + path + "/" + scene + common_args)
            for scene in tanks_and_temples_scenes:
                source = args.tanksandtemples + "/" + scene
                os.system("python train.py -s " + source + " -m eva/" + path + "/" + scene + common_args)
...
#     os.system("python metrics.py -m eval/" + scenes_string)